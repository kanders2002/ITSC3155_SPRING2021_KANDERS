...
#Test case for ends_with_consonant
    def test_ends_with_consonant(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_consonant("My name is Katie Anders"), True)

        self.assertEqual(pythonBasics3.ends_with_consonant("I love dogs"), True)

        self.assertEqual(pythonBasics3.ends_with_consonant("My favorite food is chicken alfredo"), False)
...
#Test case for ends_with_number
    def test_ends_with_number(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_number("My favorite game is Portal 2"), True)

        self.assertEqual(pythonBasics3.ends_with_number("My favorite color is greenish-blue"), False)

        self.assertEqual(pythonBasics3.ends_with_number("I was born month 5"), True)
